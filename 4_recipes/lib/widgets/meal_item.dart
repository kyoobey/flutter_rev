...
class MealItem extends StatelessWidget {
	...
	MealItem({
		...
		//@required this.removeMealCallback
	});
	...
	Widget build(BuildContext context) {
		return InkWell(onTap: () => selectMeal(context), child: Card(
			...
			child: Column(children: [
				...
				Padding(padding: EdgeInsets.all(20), child: Row(
					...
					children: [
						...
						Row(children: [Icon(Icons.work), SizedBox(width: 6), Text('${complexityString}')]),
						Row(children: [Icon(Icons.attach_money), SizedBox(width: 6), Text('${affordabilityString}')])
					]
				))
			])
		));
